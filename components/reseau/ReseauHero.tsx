...
export default function ReseauHero() {
  return (
    <section
      className="bg-white pt-16 lg:pt-20 pb-16 lg:pb-20"
      aria-labelledby="reseau-hero-heading"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.16em] text-brand-green mb-4">
              Notre Réseau
            </p>
            <h1
            ...
            >
              ...
              avec l&apos;écosystème
              <br className="hidden sm:block" />
              <span className="text-brand-green">IA global</span>
            </h1>
          ...
          <div className="relative h-[340px] sm:h-[390px] lg:h-[430px] rounded-2xl overflow-hidden border border-slate-200 shadow-[0_30px_55px_-38px_rgba(15,23,42,0.75)]">
            <Image
              src="/event-2.png"
              alt="Membres du réseau SAIEN en collaboration"
              fill
              className="object-cover"
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#0a1b2a]/35 via-transparent to-[#0a1b2a]/20" />
          </div>
        </div>
      </div>
    </section>
