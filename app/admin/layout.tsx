...
function AdminLayoutShell({ children }: AdminLayoutProps) {
  ...
  if (pathname.startsWith("/admin/membres")) {
  ...
  } else if (pathname.startsWith("/admin/profil")) {
    pageTitle = "Profil";
    pageDescription = "Consultez et mettez a jour vos informations de compte.";
    ...
    pageDescription = "Creation, edition, visibilite publique et suppression des projets.";
  } else if (pathname.startsWith("/admin/actualites")) {
    pageTitle = "Gestion des Actualites";
    pageDescription = "Creation, edition, publication et retrait des articles.";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <div className="flex-1 bg-[#F8FAFC] lg:flex lg:h-[calc(100vh-4rem)]">
        {mobileSidebarOpen && (
          <button
            type="button"
        ...
        <aside
          className={`fixed bottom-0 right-0 top-16 z-50 w-[82vw] max-w-[22rem] border-l border-gray-200 bg-white shadow-xl transition-transform duration-300 lg:static lg:z-auto lg:h-full lg:w-64 lg:max-w-none lg:translate-x-0 lg:border-l-0 lg:border-r lg:shadow-none ${
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <header className="sticky top-16 z-30 border-b border-gray-200 bg-white px-4 py-3 lg:hidden">
